...
public class RedisUtil {
	// 服务器IP地址
	private static String ADDR = "127.0.0.1";// 端口
	private static int PORT = 6379;// 密码
	private static String AUTH = "cetibs";// 连接实例的最大连接数
	...
	private static int MAX_WAIT = 10000;// 连接超时的时间
